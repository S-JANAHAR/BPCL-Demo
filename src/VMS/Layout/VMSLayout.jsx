...
function getVMSPageMeta(pathname) {
  ...
  if (pathname.includes("/on-demand")) {
    return {
      ...
      subtitle: "create, manage and deliver on demand vidoe stream",
    };
  }
  return {
    breadcrumb: ["Dashboard", "Home"],
      ...
      >
        ...
        <nav className="app-sidebar-menu">
          ...
          >
            ...
            <span className="app-sidebar-text">On-Demand Stream</span>
          </NavLink>
          ...
          >
            ...
            <span className="app-sidebar-text">Live Stream</span>
          </NavLink>
          ...
          >
            ...
            <span className="app-sidebar-text">Session</span>
          </button>
